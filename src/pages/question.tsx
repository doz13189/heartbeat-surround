    ...
    <main>
      ...
      <Box p={2}>
        ...
        >
          <Text>
            疑問)
            プルスウルトラの与ダメージ計算をしたいのですが、どうすればいいですか？
          </Text>
          <Box pt={2} pb={2}>
      ...
      <Box p={2}>
        ...
        >
          <Text>
            疑問)
            ディフェンスダウンをたくさん入れているのに思っているより与ダメージが出ないのですが、なぜですか？
          </Text>
          <Box pt={2} pb={2}>
            <Text>
              回答)
      ...
      <Box p={2}>
        ...
        >
          <Text>
            疑問) アリーナだと与ダメージの計算結果が合いません。なぜですか？
          </Text>
          <Box pt={2} pb={2}>
            <Text>
              回答)
              アリーナは1ターン目は与ダメージが30%減少します。2ターン目は20%減少します。このようにターン毎に異なる与ダメージ減少率が適用されます。
            </Text>
          </Box>
        </Box>
      </Box>
